...
import '../../add_Validación.dart';
import '../../add_parada.dart';


//import 'package:provider/provider.dart';


class GestionRutasMenu extends StatefulWidget {
  GestionRutasMenu({Key key}) : super(key: key);
...
class HomeWidgetState extends State<GestionRutasMenu>
    with SingleTickerProviderStateMixin {
  final List<Tab> tabs = <Tab>[
    new Tab(text: "Agregar Descripción de Ruta"),
    new Tab(text: "Agregar Paradas a Ruta"),
    new Tab(text: "Validación de Rutas"),
...
class RegistreRutas extends StatelessWidget {
  const RegistreRutas({
    Key key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          Navigator.pushNamed(context, 'regRutas');
          if (await Vibration.hasVibrator()) {
    Vibration.vibrate();
}
        },

                ...
                child: Column(
                  children: <Widget>[
                    ...
                    SafeArea(
                      child: Column(
                        children: <Widget>[
                          Text('Registro de Vehículo'.toUpperCase(), textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18,color: Colors.blueGrey),),
                          SizedBox(height: 5,),
                          CircleAvatar(
                                     backgroundImage: AssetImage("assets/imgEps/VehiculoEps.png"),
                                     radius: 30,
                          ),

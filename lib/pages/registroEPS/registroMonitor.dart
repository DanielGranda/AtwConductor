...
class ResgistroMonitor extends StatefulWidget {
  ResgistroMonitor({Key key}) : super(key: key);

  @override
  _ResgistroMonitorState createState() => _ResgistroMonitorState();
}

class _ResgistroMonitorState extends State<ResgistroMonitor> {
                  ...
                  children: <Widget>[
                    SafeArea(
                      child: Column(
                        children: <Widget>[
                          Text(
                            'Registro de Monitor'.toUpperCase(),
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                FormBuilderSwitch(
                                  ...
                                  inactiveTrackColor: Color(hexColor('#E86A87'))
                                      .withOpacity(0.5),
                                  label: Text('¿Usted tambien es conductor?'),
                                  attribute: "TambienMonitor",
                                  initialValue: true,
                                ),
                                SizedBox(
                                  height: 10,

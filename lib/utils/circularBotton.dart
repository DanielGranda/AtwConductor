...
class CircularBottomNavigation extends StatefulWidget {
  ...
  final Color normalcontainerColor;
  ...
  CircularBottomNavigation(this.tabItems,
      {this.selectedPos = 0,
        ...
        this.selectedContainerColor= Colors.white,
        this.normalcontainerColor= Colors.grey, this.urlIcon,})
...
class _CircularBottomNavigationState extends State<CircularBottomNavigation>
  ...
  Widget build(BuildContext context) {
    ...
    children.add(Positioned(
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [new BoxShadow(color:Color(hexColor('#F6C34F')), blurRadius: 2.0)]),
      ),
    ...
    boxes.asMap().forEach((int pos, Rect r) {
      ...
      pos == selectedPos ? widget.selectedContainerColor : widget.normalcontainerColor; */
      ...
      children.add(
        Positioned(
          child: Transform.scale(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(20),
                ...
                child:Image.asset(widget.tabItems[pos].urlImage),
          ...
          left: r.center.dx - (widget.containerSize / 2),
          top: r.center.dy -
